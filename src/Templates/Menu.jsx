...
let Menu =()=>{
    ...
    return<>
    <div className="w-[61%] mx-auto  flex justify-between py-6.5 ">
  <div className="flex justify-center   gap-2  items-center">
      <img src="/public/images/karospace.svg" alt="" className="w-42.25 h-11" />
    <div className="flex rounded-full px-1.5 justify-center items-center gap-1 h-8 btn-border border hover:scale-110 transition">
