      ...
      >
        ...
        <div className="w-[71%] mx-auto grid grid-cols-2 gap-2.5 mt-10 ">
          <div className="w-full border border-[#e1e1e3] shadow-lg p-6.5 rounded-[20px] bg-white">
            <h1 className="mb-4 text-[17px] font-extrabold">
              Product Overview
            </h1>
            <p className="text-[#767a90] text-[14.5px]">
          ...
          <div className="w-full border border-[#e1e1e3] shadow-lg p-6.5 rounded-[20px] bg-white">
            ...
            {Array.from({ length: 12 }).map((_, index) => (
              ...
              >
                ...
                <span className="text-[13.5px] font-bold">190 – 1100 nm</span>
              </div>
            ))}
          </div>
        </div>
        <div className="w-[71%] mx-auto flex flex-col mt-8 py-4 ">
          <SwiperProduct />
        </div>

        <div className="w-[71%] mx-auto grid grid-cols-2 gap-2.5 mt-10 ">
          <div className="p-6.5 rounded-[20px] border border-[#e1e1e3] bg-white shadow-lg">
            <h3 className="text-[17px] font-extrabold mb-4">Downloads</h3>
            {pdfs.map((elem, index) => (
              <div
                className="px-4 py-4.5 rounded-xl bg-[#f7f7fb] flex justify-between items-center mt-2"
                key={index}
              >
                <div className="flex gap-2 items-center">
                  <div
                    className={`rounded-[9px] flex justify-center items-center p-2 ${elem.bg}`}
                  >
                    <AiOutlineFilePdf />
                  </div>
                  <p className="text-[14px] font-bold">{elem.title}</p>
                </div>
                <a
          ...
          <div className="bg-white border border-[#e9e9f1] rounded-2xl p-[26px] shadow-[0_2px_4px_rgba(16,18,35,0.04),0_14px_30px_-16px_rgba(16,18,35,0.12)]">
            <h3 className="text-[17px] font-extrabold mb-4">FAQ</h3>

            <div className="divide-y divide-[#e9e9f1]">
              <details className="group py-[14px] first:pt-0">
                <summary className="flex items-center justify-between text-[14px] cursor-pointer list-none [&::-webkit-details-marker]:hidden">
                  What is the wavelength range?
                  <span className="text-[#6d5bf0] transition-transform duration-200 group-open:rotate-180">
                    ⌄
                  </span>
                </summary>
